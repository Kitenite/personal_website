  ...
  return(
   <BlogLayout>
      ...
      <p className = "content-body">
        ...
        <br/>
        <br/>
        <img src={"../blog/digit/tensorflow-logo.png"} alt="Tensorflow logo" ></img>
        ...
        <br/>
        <br/>
        <img src={"../blog/digit/tensorflow-code.png"} alt="Tensorflow code" style={{maxHeight:"20vh"}}></img>
        <br/>
        <br/>
        ...
        <br/>
        <img src={"../blog/digit/accuracy.png"} alt="Test accuracy"/>
        <br/>
        <br/>
        ...
        <br/>
        <img src={"../blog/digit/react-logo.png"} alt="React logo"/>
        <br/>
        Pixel board:
        ...
        <br/>
        <img src={"../blog/digit/drawing-pad.png"} alt="Drawing pad"/>
        <br/>
        ...
        <br/>
        <br/>
        <img src={"../blog/digit/side-by-side.png"} alt="Comparison of processed image and MNIST image"/>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        <img src={"../blog/digit/image-result.png"} alt="Image result"/>
        <br/>
        <br/>
        It works!
        <br/>
        ...
        <br/>
        <br/>
        <img src={"../blog/digit/docker-logo.png"} alt="Docker logo"/>
        ...
        <br/>
        <br/>
        <img src={"../blog/digit/docker-test.png"} alt="Docker test"/>
        <br/>
        <br/>
        Awesome. Now we use the client REST api to talk to our container.
        <br/>
        <br/>
        <img src={"../blog/digit/REST-test.png"} alt="REST API test"/>
        <br/>
        <br/>
        ...
        <br/>
        <br/>
        <img src={"../blog/digit/EC2-logo.png"} alt="AWS EC2 logo"/>
        ...
        <br/>
        <br/>
        <img src={"../blog/digit/app-screenshot.png"} alt="App screenshot"/>
