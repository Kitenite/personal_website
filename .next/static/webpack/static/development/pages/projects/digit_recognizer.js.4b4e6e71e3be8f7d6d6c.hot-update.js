...
function ResultGraph(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      style: {
        backgroundColor: result[1] > 75 ? '#5DEBA4' : result[1] >= 50 ? 'orange' : 'red',
        height: result[1] * 2
      },
