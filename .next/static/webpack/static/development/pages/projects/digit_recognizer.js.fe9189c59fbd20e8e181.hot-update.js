...
function DrawingCanvas() {
  ...
  return __jsx("div", null, __jsx(react_signature_canvas__WEBPACK_IMPORTED_MODULE_3___default.a, {
    ...
    className: "button",
    onClick: submitPad
  }, "submit")), error ? __jsx("p", null, "Something went wrong, check your connection") : null, resultArray ? __jsx("div", null, result_graph(resultArray)) : null, imageURL ? __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx("p", null, "Processed Digit"), __jsx("img", {
    src: imageURL,
    alt: "my signature",
    style: {
      display: "block",
...
//# sourceMappingURL=digit_recognizer.js.fe9189c59fbd20e8e181.hot-update.js.map