...
function ResultGraph(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      style: {
        backgroundColor: result[1] > 10 ? 'green' : 'green',
        height: result[1] * 2
      },
