...
function ResultGraph(props) {
  ...
  return __jsx("div", {
    className: "jsx-3722787209"
  }, __jsx("p", {
    className: "jsx-3722787209" + " " + "title"
  }, "Result"), __jsx("a", {
    className: "jsx-3722787209" + " " + "final-answer"
  }, "Final answer: ", resultArray[0][0]), __jsx("p", {
    className: "jsx-3722787209" + " " + "title"
  }, "Confidence breakdown:"), resultArray.map(function (result, index) {
    return __jsx("div", {
      className: "jsx-3722787209" + " " + "confidence-element"
    }, __jsx("div", {
      style: {
        backgroundColor: result[1] > 75 ? '#5DEBA4' : result[1] >= 50 ? '#FFCA41' : '#FF6868',
        height: result[1] * 2
      },
      className: "jsx-3722787209" + " " + "bar"
    }), __jsx("p", {
      className: "jsx-3722787209"
    }, result[0]), __jsx("p", {
      className: "jsx-3722787209"
