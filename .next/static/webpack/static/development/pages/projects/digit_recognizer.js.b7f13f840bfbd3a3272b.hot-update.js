...
function ResultGraph(props) {
  ...
  return __jsx("div", {
    ...
    return __jsx("div", {
      ...
      style: {
        backgroundColor: result[1] > 50 ? 'green' : 'red',
        height: result[1] * 2
      },
