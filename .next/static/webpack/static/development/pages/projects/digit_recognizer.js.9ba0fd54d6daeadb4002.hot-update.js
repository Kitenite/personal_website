...
function DrawingCanvas() {
  ...
  return __jsx("div", null, __jsx(react_signature_canvas__WEBPACK_IMPORTED_MODULE_3___default.a, {
    ...
    className: "button",
    onClick: submitPad
  }, "submit")), resultArray ? __jsx("div", null, result_graph(resultArray)) : null, imageURL ? __jsx(react__WEBPACK_IMPORTED_MODULE_2___default.a.Fragment, null, __jsx("a", null, "Processed Digit"), __jsx("br", null), __jsx("img", {
    src: imageURL,
    alt: "my signature",
    style: {
      display: "block",
...
//# sourceMappingURL=digit_recognizer.js.9ba0fd54d6daeadb4002.hot-update.js.map